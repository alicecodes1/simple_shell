...
/**
 * find_env - find given env variable in linked list
 ...
 * @env: linked list
 * @str: user's typed in cmd (e.g. "unsetenv MAIL")
 * Return: 0 on success
 */
int _unsetenv(list_t **env, char **str)
{
	...
	/* get idx of node to delete */
	free_double_ptr(str);
	if (index == -1)
	/* check if index errored */
	{
...
/**
 * _setenv - create or modify existing env variable in linked list
 * @env: linked list
 * @str: user's typed in cmd (e.g. "setenv USER Superman")
